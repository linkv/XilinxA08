...
HD_PWD='F:/summerclass/UART_DDS/UART_DDS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_DDS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_DDS.tcl -notrace
