...
HD_PWD='F:/summerclass/UART_DDS/UART_DDS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_DDS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_DDS.tcl
